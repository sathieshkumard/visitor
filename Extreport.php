   ...
   <td> 
    ...
    <td align="center">		  
		  <?php
				...
				{
					$filter = $_POST['filter'];
					$result = mysql_query("SELECT * FROM extension");
				}
				else
				{
					$result = mysql_query("SELECT * FROM extension");
				...
				<th>Employee ID</th><th>Employee Name</th><th>Designation</th><th>Division</th><th>Department</th><th>Channel</th><th>Mobile No</th><th>Email ID</th>';
