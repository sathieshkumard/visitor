...
<title>Student Visitor Report</title>
  ...
  <tr>
    ...
    <td align="center">		  
		  <?php
				...
				{
					$filter = $_POST['filter'];
					$result = mysql_query("SELECT * FROM svis");
				}
				else
				{
					$result = mysql_query("SELECT * FROM svis");
				...
				<th>Student Details</th><th>Visitor Name</th><th>Gender of Visitor</th><th>Reason for Visit</th><th>Visitor Information</th><th>Visited Date</th>';
