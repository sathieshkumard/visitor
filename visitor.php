...
<table border="0" align="center" bgcolor="#87CEFA" height="200">
  ...
  <tr>
    <td align="center">
	<form id="f1" action="insertgvis.php" id="registration" name="registration" method="post" onSubmit="return reg()">
	...
	{
	$Qry = mysql_query("SELECT ifnull(max(cid),0) as count FROM gvis"); 
...
<td><input name="allotted" type="text" id="allotted"  width="200" /></td>
	...
	<tr>
          <td>Time in</td>
<td><input name="tin" type="text" id="tin"  width="200" /></td>
            </tr>  
			<tr>
          <td>Time out</td>
<td><input name="tout" type="text" id="tout"  width="200" /></td>
            </tr>  
	<tr>
