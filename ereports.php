...
<title>Employeewise Visitor Report</title>
...
<form action="" method="post" name="frm_login" id="frm_login" enctype="multipart/form-data">
          <table width="100%" border=0 align="center">
                  <tr >
                    <th colspan="5" id="formhedear">Employeewise Visitor Report</th>
                  </tr>
                 
                  <tr>
                    <td width="245" height="37"><div align="right"><strong><font color="#FF0000"></font>Employee ID : </strong></div></td>
                    <td>
<label>
...
if(mysql_select_db("svisitor",$con))
	{
	$Qry = mysql_query("SELECT eid  FROM charge"); 
...
?>
 ...
 <?php
   ...
   {
    $eid=$_POST['eid'];
    $get= @mysql_query("SELECT * FROM charge WHERE eid= '$eid' ")or die(mysql_error());
