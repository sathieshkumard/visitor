...
<table border="0" align="center" bgcolor="#87CEFA" height="200">
  ...
  <tr>
    <td align="center">
	<form id="f1" action="insertdept.php" >
	...
	{
	$Qry = mysql_query("SELECT ifnull(max(did),0) as count FROM department"); 
...
<td><input name="noc" type="text" id="noc"  width="200" /></td>
            </tr>  
